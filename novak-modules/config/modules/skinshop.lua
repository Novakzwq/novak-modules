Config.skinshop = {
    ...
    { name = "Loja de Roupas",
        locs = {
            ...
            -- OUTROS
            { ['x'] = -503.74, ['y'] = 2976.42, ['z'] = 27.64, provador = {['x'] = -503.74, ['y'] = 2976.42, ['z'] = 27.64, heading = 262.43}},
            { ['x'] = -91.24, ['y'] = 2205.2, ['z'] = 158.64, provador = {['x'] = -91.24, ['y'] = 2205.2, ['z'] = 158.64, heading = 112.29}}, -- Roxo
            { x = 454.47, y = -989.85, z = 30.69, provador = {x = 454.47, y = -989.85, z = 30.69, heading = 175.24}}, -- DP Centro
            { x = 75.75, y = 3714.6, z = 48.26, provador = {x = 75.75, y = 3714.6, z = 48.26, heading = 175.24}}, -- 
            { x = 1325.0, y = -185.38, z = 109.59, provador = { x = 1325.0, y = -185.38, z = 109.59, heading = 118.79 }}, -- 
            
            --{ id = 73, color = 13, x = 199.84, y = -873.27, z = 30.72, provador = {x = 199.84, y = -873.27, z = 30.72, heading = 166.14}},    
        },
        clouth = {
            [1] = { price = 500 }, -- mascara
            [3] = { price = 500 }, -- maos
            ...
            [8] = { price = 500 }, -- camisa,
            [9] = { price = 500 },
            [10] = { price = 500 }, -- adesivo
            [11] = { price = 500 }, -- jaqueta
            ['p0'] = { price = 500 }, -- bone/chapeu
            ['p1'] = { price = 500 }, -- oculos
            ['p2'] = { price = 500 }, -- brinco
            ['p6'] = { price = 500 }, -- relogio
            ['p7'] = { price = 500 }, -- bracelete
        }    
    },
